/* Exercicio 13: Semelhante ao Exercicio 9
...
Nova implementação:
Agora este código permite repetir a operação o quanto o usuário desejar, este deve informar incialmente 
a quanidade desejada
*/
var numTransacoes = parseInt(prompt('Informe o número de transações que deseja realizar: '));

for (var i = 1; i <= numTransacoes; i++) {
